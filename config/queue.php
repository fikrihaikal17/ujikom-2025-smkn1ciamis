...
return [
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | Laravel's queue supports an assortment of back-ends via a single, unified
  ...
  /*
    ...
    | each back-end. You're also free to add additional connections.
    |
    */
  ...
  /*
    ...
    | a database failed job provider that works with all supported databases.
    |
    */
